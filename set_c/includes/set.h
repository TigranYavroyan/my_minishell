...
// helpers
t_setnode_ptr					make_set_node(t_node_ptr key,
									t_quote_type q_type);
...
// insertion
void							insert_set(t_set_ptr set, t_node_ptr key,
									t_quote_type q_type);
...
// traverse
void							traverse_set(t_set_ptr tree,
									t_travers_type_set travers_type,
									t_visitor_set fptr);
...
// quote_check.c
bool							is_single_quoted(t_set_ptr set,
									t_node_ptr curr);
