...
/*   Updated: 2024/11/12 00:20:23 by healeksa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_bst_ptr						matrix_to_bst_none_sorted(char **matrix,
									char delim);
...
t_value_type					get_bst_range(t_bst_ptr bst,
									const t_key_type begin,
...
t_treenode_ptr					_make_node_move(t_key_type key,
									t_value_type value, t_treenode_ptr left,
									t_treenode_ptr right);
...
void							traverse_bst(t_bst_ptr tree,
									t_travers_type_bst travers_type,
									t_visitor_bst fptr);
